...
namespace SacramentPlanner_Sandbox.Data
{
    public class DbInitializer
    {
        public static void Initialize(MeetingContext context)
        {
            ...
            var hymns = new Hymn[]
            {
                  new Hymn{HymnNumber=310,HymnName="A Key Was Turned in Latter Days (Women)"}
                ...
                , new Hymn{HymnNumber=275,HymnName="A voice hath spoken from the dust"}
                ...
                , new Hymn{HymnNumber=328,HymnName="An Angel from on High (Men’s Choir)"}
                ...
                , new Hymn{HymnNumber=308,HymnName="As I have loved you"}
                , new Hymn{HymnNumber=277,HymnName="As I Search the Holy Scriptures"}
                , new Hymn{HymnNumber=306,HymnName="As I watch the rising sun"}
                , new Hymn{HymnNumber=169,HymnName="As Now We Take the Sacrament"}
                , new Hymn{HymnNumber=309,HymnName="As Sisters in Zion (Women)"}
                ...
                , new Hymn{HymnNumber=320,HymnName="Brethren, power by earthly standards (Men)"}
                , new Hymn{HymnNumber=335,HymnName="Brightly Beams Our Father’s Mercy (Men’s Choir)"}
                ...
                , new Hymn{HymnNumber=322,HymnName="Come, All Ye Sons of God (Men)"}
                ...
                , new Hymn{HymnNumber=326,HymnName="Come, Come, Ye Saints (Men’s Choir)"}
                ...
                , new Hymn{HymnNumber=332,HymnName="Come, O Thou King of Kings (Men’s Choir)"}
                ...
                , new Hymn{HymnNumber=313,HymnName="Earth, with her ten thousand flowers (Women)"}
                , new Hymn{HymnNumber=87,HymnName="Earth, with her ten thousand flowers"}
                , new Hymn{HymnNumber=140,HymnName="Ere you left your room"}
                ...
                , new Hymn{HymnNumber=255,HymnName="Firm as the mountains around us"}
                ...
                , new Hymn{HymnNumber=327,HymnName="Go, Ye Messengers of Heaven (Men’s Choir)"}
                ...
                , new Hymn{HymnNumber=313,HymnName="God Is Love (Women)"}
                ...
                , new Hymn{HymnNumber=341,HymnName="God save our gracious King!"}
                ...
                , new Hymn{HymnNumber=333,HymnName="High on the Mountain Top (Men’s Choir)"}
                ...
                , new Hymn{HymnNumber=314,HymnName="How Gentle God’s Commands (Women)"}
                ...
                , new Hymn{HymnNumber=300,HymnName="I have a family here on earth"}
                ...
                , new Hymn{HymnNumber=135,HymnName="I know that my Redeemer lives, Triumphant Savior"}
                , new Hymn{HymnNumber=334,HymnName="I Need Thee Every Hour (Men’s Choir)"}
                ...
                , new Hymn{HymnNumber=114,HymnName="I wander through the still of night"}
                , new Hymn{HymnNumber=128,HymnName="I will not doubt, I will not fear"}
                ...
                , new Hymn{HymnNumber=230,HymnName="In a world where sorrow"}
                ...
                , new Hymn{HymnNumber=148,HymnName="In sweet remembrance of thy Son"}
                ...
                , new Hymn{HymnNumber=270,HymnName="It may not be on the mountain height"}
                ...
                , new Hymn{HymnNumber=101,HymnName="Jesus, my Savior true"}
                ...
                , new Hymn{HymnNumber=315,HymnName="Jesus, the Very Thought of Thee (Women)"}
                ...
                , new Hymn{HymnNumber=318,HymnName="Love at Home (Women)"}
                ...
                , new Hymn{HymnNumber=60,HymnName="Mine eyes have seen the glory"}
                ...
                , new Hymn{HymnNumber=106,HymnName="Now to heaven our prayer ascending"}
                ...
                , new Hymn{HymnNumber=337,HymnName="O Home Beloved (Men’s Choir)"}
                , new Hymn{HymnNumber=208,HymnName="O Little Town of Bethlehem"}
                , new Hymn{HymnNumber=86,HymnName="O Lord my God"}
                ...
                , new Hymn{HymnNumber=338,HymnName="Oh, beautiful for spacious skies"}
                , new Hymn{HymnNumber=202,HymnName="Oh, Come, All Ye Faithful"}
                , new Hymn{HymnNumber=271,HymnName="Oh, Holy Words of Truth and Love"}
                , new Hymn{HymnNumber=26,HymnName="Oh, how lovely was the morning"}
                , new Hymn{HymnNumber=123,HymnName="Oh, May My Soul Commune with Thee"}
                , new Hymn{HymnNumber=340,HymnName="Oh say, can you see"}
                , new Hymn{HymnNumber=272,HymnName="Oh Say, What Is Truth?"}
                , new Hymn{HymnNumber=331,HymnName="Oh Say, What Is Truth? (Men’s Choir)"}
                , new Hymn{HymnNumber=286,HymnName="Oh, What Songs of the Heart"}
                , new Hymn{HymnNumber=138,HymnName="On bended knees, with broken hearts"}
                ...
                , new Hymn{HymnNumber=323,HymnName="Rise Up, O Men of God (Men’s Choir)"}
                , new Hymn{HymnNumber=324,HymnName="Rise Up, O Men of God (Men)"}
                ...
                , new Hymn{HymnNumber=220,HymnName="Savior, may I learn to love thee"}
                , new Hymn{HymnNumber=112,HymnName="Savior, Redeemer of My Soul"}
                , new Hymn{HymnNumber=230,HymnName="Scatter Sunshine"}
                , new Hymn{HymnNumber=336,HymnName="School Thy Feelings (Men’s Choir)"}
                , new Hymn{HymnNumber=144,HymnName="Secret Prayer"}
                , new Hymn{HymnNumber=330,HymnName="See, the Mighty Angel Flying (Men’s Choir)"}
                , new Hymn{HymnNumber=325,HymnName="See the Mighty Priesthood Gathered (Men’s Choir)"}
                , new Hymn{HymnNumber=254,HymnName="Shall the youth of Zion falter"}
                ...
                , new Hymn{HymnNumber=317,HymnName="Sweet Is the Work (Women)"}
                ...
                , new Hymn{HymnNumber=305,HymnName="The light of God rests on the face"}
                ...
                , new Hymn{HymnNumber=316,HymnName="The Lord Is My Shepherd (Women)"}
                , new Hymn{HymnNumber=109,HymnName="The Lord My Pasture Will Prepare"}
                , new Hymn{HymnNumber=1,HymnName="The Morning Breaks"}
                , new Hymn{HymnNumber=320,HymnName="The Priesthood of Our Lord (Men)"}
                ...
                , new Hymn{HymnNumber=137,HymnName="The witness of the Holy Ghost"}
                , new Hymn{HymnNumber=252,HymnName="The world has need of willing men"}
                , new Hymn{HymnNumber=194,HymnName="There Is a Green Hill Far Away"}
                , new Hymn{HymnNumber=144,HymnName="There is an hour of peace and rest"}
                , new Hymn{HymnNumber=294,HymnName="There is beauty all around"}
                , new Hymn{HymnNumber=318,HymnName="There is beauty all around (Women)"}
                ...
                , new Hymn{HymnNumber=49,HymnName="This earth was once a garden place"}
                ...
                , new Hymn{HymnNumber=329,HymnName="Thy Servants Are Prepared (Men’s Choir)"}
                ...
                , new Hymn{HymnNumber=176,HymnName="’Tis Sweet to Sing the Matchless Love(MEREDITH)"}
                , new Hymn{HymnNumber=177,HymnName="’Tis Sweet to Sing the Matchless Love(HANCOCK)"}
                , new Hymn{HymnNumber=274,HymnName="To Nephi, seer of olden time"}
                ...
                , new Hymn{HymnNumber=312,HymnName="We Ever Pray for Thee (Women)"}
                , new Hymn{HymnNumber=93,HymnName="We gather together"}
                ...
                , new Hymn{HymnNumber=279,HymnName="We love to hear thy holy word"}
                , new Hymn{HymnNumber=311,HymnName="We Meet Again as Sisters (Women)"}
                ...
                , new Hymn{HymnNumber=188,HymnName="When in the wondrous realms above"}
                , new Hymn{HymnNumber=276,HymnName="When the rosy light of morning"}
                , new Hymn{HymnNumber=241,HymnName="When upon life’s billows"}
                , new Hymn{HymnNumber=129,HymnName="Where Can I Turn for Peace?"}
                , new Hymn{HymnNumber=173,HymnName="While of These Emblems We Partake (SAUL)"}
                , new Hymn{HymnNumber=174,HymnName="While of These Emblems We Partake (AEOLIAN)"}
                ...
                , new Hymn{HymnNumber=319,HymnName="Ye Elders of Israel (Men)"}
                , new Hymn{HymnNumber=118,HymnName="Ye Simple Souls Who Stray"}
                , new Hymn{HymnNumber=321,HymnName="Ye Who Are Called to Labor (Men)"}
